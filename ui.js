...
async function renderNavbar(activePage = '') {
  ...
  nav.innerHTML = `
    <a href="/index.html" class="nav-logo">
      <span class="nav-logo-text"><img src="https://vudxovvqpjdhlemugtqh.supabase.co/storage/v1/object/public/assets/logo.png" alt="Scent Haven" style="height:44px;width:auto;vertical-align:middle;"> <span style="display:none">Scent Haven</span></span>
    </a>
    <ul class="nav-links">
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          <div class="footer-brand-name"><img src="https://vudxovvqpjdhlemugtqh.supabase.co/storage/v1/object/public/assets/logo.png" alt="Scent Haven" style="height:80px;width:auto;margin-bottom:0.5rem;display:block;"></div>
